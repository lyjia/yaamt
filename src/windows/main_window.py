...
class MainWindow(QMainWindow):
    ...
    def _populate_file_action_menu(self, menu: QMenu) -> None:
        ...
        Metadata) to the given menu in canonical order. Called by both the File
        menu and the files-view right-click menu so their ordering stays in sync."""
        ...
        menu.addMenu(self._build_metadata_menu())
